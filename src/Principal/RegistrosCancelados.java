...
public final class RegistrosCancelados extends javax.swing.JFrame {
    Registro registro = new Registro();
    public static int id;
    public RegistrosCancelados() {
        initComponents();
        MostrarRegistroDiario();
    }
    public RegistrosCancelados(int id) {
        RegistrosCancelados.id=id;
        initComponents();
        MostrarRegistroDiario();
    }
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registros Cancelados");
    ...
    private void tblRegistroDiarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroDiarioMouseClicked
        ...
        try{
            ...
            if(RowSelect==-1){
                ...
                int DialogResult = JOptionPane.showConfirmDialog(null,"Desea restaurar este registro? ");  
                if(DialogResult == JOptionPane.YES_OPTION){
                        String Fecha=(String) modelo2.getValueAt(RowSelect,0);
                        ...
                        registro.RestaurarRegistro(Matricula,Practica,HoraInicio,HoraFin,Fecha);
                        modelo2.setValueAt("realizado",RowSelect, 8);
                        modelo2.setValueAt("",RowSelect,9);                    
                }
                else{     
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrosCancelados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrosCancelados().setVisible(true);            
            }
        });
    }
    ...
    public void MostrarRegistroDiario() {
        ...
        modelo2.addColumn("fecha");//seccion 0
        ...
        for (int i = 0; i < 8; i++) {
            ...
            BD bd = new BD();
            bd.conecta();
            String Matricula, Nombre, Grupo, Practica, HoraEntrada, HoraSalida, Estado, Comentario,codigo,fecha;
            int j=1;
            try {
                Statement stmnt;
                stmnt = bd.conecta().createStatement();
                String sql = "call spMostrarRegistrosCancelados();";
                ...
                while (rs.next()) {
                    ...
                    modelo2.addRow(new Object[]{fecha,Matricula,Nombre,Grupo,codigo,Practica,HoraEntrada,HoraSalida,Estado,Comentario});   
